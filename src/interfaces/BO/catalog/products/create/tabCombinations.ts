...
export interface BOProductsCreateTabCombinationsPageInterface extends BOBasePagePageInterface {
  readonly editCombinationsModalMessage: (number: number) => string;
  readonly editCombinationsModalTitle: (number: number) => string;
  readonly generateCombinationsMessage: (number: number) => string;
  readonly successfulGenerateCombinationsMessage: (number: number) => string;
