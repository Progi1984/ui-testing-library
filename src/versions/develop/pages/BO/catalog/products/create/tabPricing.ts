...
class PricingTab extends BOBasePage implements BOProductsCreateTabPricingPageInterface {
  ...
  private readonly combinationToSelectButton: (idCombination: number) => string;
  ...
  constructor() {
    ...
    this.combinationToSelectButton = (idCombination: number) => `li.select2-results__option:nth-child(${idCombination})`;
