...
class DetailsTab extends BOBasePage implements BOProductsCreateTabDetailsPageInterface {
  ...
  private readonly referenceFormErrorMessage: (inputNumber:number) => string;
  ...
  constructor() {
    ...
    this.referenceFormErrorMessage = (inputNumber:number) => `#product_details_references div:nth-child(${inputNumber})`
    + ' div.alert-text';
    // Features section
