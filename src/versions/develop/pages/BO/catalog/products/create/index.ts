...
import boProductsCreateTabDetailsPage from '@pages/BO/catalog/products/create/tabDetails';
import boProductsCreateTabPackPage from '@pages/BO/catalog/products/create/tabPack';
import boProductsCreateTabPricingPage from '@pages/BO/catalog/products/create/tabPricing';
 ...
 * @extends BOBasePage
 */
class BOProductsCreatePage extends BOBasePage implements BOProductsCreatePageInterface {
  ...
  async setProduct(page: Page, productData: FakerProduct): Promise<string|null> {
    ...
    if (productData.category !== '') {
      await boProductsCreateTabDescriptionPage.addNewCategory(page, [productData.category]);
      await boProductsCreateTabDescriptionPage.chooseDefaultCategory(page, productData.category);
    }
    // Set brand
    if (productData.brand) {
      await boProductsCreateTabDescriptionPage.chooseBrand(page, productData.brand.name);
    }
...
const boProductsCreatePage = new BOProductsCreatePage();
export {boProductsCreatePage, BOProductsCreatePage};
